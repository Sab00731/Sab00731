...
### About Me
I'm an aspiring Embedded Systems & Chip Design engineer. Currently leading the Avionics team for our Rocketeering Club, focusing on high-altitude flight computers and sensor fusion.
...
| **Languages** | `C`, `C++`, `Python` |
| **Embedded** | `FreeRTOS`, `ESP32`, `ATtiny`, `Arduino` |
| **Tools** | `Arduino IDE`, `MATLAB`, `Logisim`, `LTspice`|

---

### My Projects
* **Avionics Flight Computer** – Robust sensor fusion for high-altitude rocketry.
